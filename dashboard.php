                    ...
                    <table id="myTable">
                        ...
                        <tbody>
                            ...
                            <tr id="trs">
                                ...
                                <td><a href="/users.php?users=<?=$presence['id_utilisateur'];?>" class="font-medium text-blue-600 underline dark:text-blue-500 hover:no-underline"  ><?= htmlspecialchars($presence['nom']) ?></a></td>
